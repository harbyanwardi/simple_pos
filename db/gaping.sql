...
('BR000001', 'Alderon Putih Panjang', '1M3', 1600000, 0, 1000000, 75, 1, '2019-05-01 05:47:03', '2021-06-30 18:50:56', 7, 1),
('BR000002', 'Alderon Biru Panjang', '2M3', 700000, 0, 1000000, 47, 1, '2019-05-01 05:47:35', '2021-06-30 18:51:11', 9, 1),
...
(21, 'K1123456', 'BR000001', 1600000, 10, 16000000, 'A300621000001'),
(22, 'K1123456', 'BR000002', 700000, 15, 10500000, 'A300621000001'),
(23, 'K1123457', 'BR000001', 1600000, 5, 8000000, 'A300621000002');
...
INSERT INTO `tbl_jurnal` (`id_jurnal`, `id_jurnal_umum`, `id_akun`, `deskripsi`, `debit`, `kredit`) VALUES
(2, 2, '3-3001', 'Laba Ditahan', 10000000, 0),
(3, 3, '2-2001', 'Hutang Dividen', 0, 7000000),
(4, 4, '1-2001', 'Kas', 0, 3000000),
(5, 2, '1-1002', 'Kas', 0, 3000000),
(6, 2, '9-0001', 'Utang Berjalan', 0, 4000000);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_jurnal_parent`
--

CREATE TABLE `tbl_jurnal_parent` (
  `id_jurnal_parent` int(11) NOT NULL,
  `no_trans` varchar(30) NOT NULL,
  `tanggal` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tbl_jurnal_parent`
--

INSERT INTO `tbl_jurnal_parent` (`id_jurnal_parent`, `no_trans`, `tanggal`) VALUES
(1, '', '2021-06-30'),
(2, 'L01', '2021-06-30');
...
--
-- Indeks untuk tabel `tbl_jurnal_parent`
--
ALTER TABLE `tbl_jurnal_parent`
  ADD PRIMARY KEY (`id_jurnal_parent`);
...
--
ALTER TABLE `tbl_detail_beli`
  MODIFY `d_beli_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_jurnal_parent`
--
ALTER TABLE `tbl_jurnal_parent`
  MODIFY `id_jurnal_parent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
