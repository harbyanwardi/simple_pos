   ...
   ?>
            ...
            <div class="col-lg-12">
                <h1 class="page-header">Data
                    <small>Barang</small>
                    <div class="pull-right"><a href="<?php echo base_url().'admin/jurnal/tambah'?>" class="btn btn-sm btn-success" ><span class="fa fa-plus"></span> Tambah Barang</a></div>
                </h1>
            </div>
        </div>
        <!-- /.row -->
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-xs btn-warning" href="<?php echo base_url().'admin/jurnal/detail/'.$id?>" title="Edit"><span class="fa fa-eye"></span> Detail</a>
