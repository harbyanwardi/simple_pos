                ...
                <tbody>
                   ...
                   <!--  <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/lap_data_barang'?>" target="_blank"><span ></span> Print</a>
                        </td>
                    </tr>
 -->
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/lap_stok_barang'?>" target="_blank"><span ></span> Print</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/lap_data_penjualan'?>" target="_blank"><span ></span> Print</a>
                        </td>
                    </tr>
                    ...
                    <!-- <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#lap_jual_pertanggal" data-toggle="modal"><span ></span> Print</a>
                        </td>
                    </tr> -->
                    ...
                    <!-- <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#lap_jual_perbulan" data-toggle="modal"><span ></span> Print</a>
                        </td>
                    </tr> -->
                   ...
                   <!--  <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#lap_jual_pertahun" data-toggle="modal"><span ></span> Print</a>
                        </td>
                    </tr> -->
                     ...
                     <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="#lap_laba_rugi" data-toggle="modal"><span ></span> Print</a>
                        </td>
                    </tr>

                   <!--  <tr>
                        <td style="text-align:center;vertical-align:middle">2</td>
                        <td style="vertical-align:middle;">Transaction History</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/historytransaction'?>" target="_blank"><span ></span> Print</a>
                        </td>
                    </tr> -->
                   ...
                   <!--  <tr>
                        ...
                        <td style="text-align:center;">
                            <a target="_blank" class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/lap_data_pembelian'?>" data-toggle="modal"><span ></span> Print</a>
                        </td>
                    </tr> -->
<!-- 
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a target="_blank" class="btn btn-sm btn-default" href="<?php echo base_url().'admin/laporan/lap_retur'?>" data-toggle="modal"><span ></span> Print</a>
                        </td>
                    </tr> -->
        ...
        <div class="modal fade" id="lap_jual_pertanggal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/lap_penjualan_pertanggal'?>" target="_blank">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-info"><span ></span> Cetak</button>
                </div>
            </form>
            </div>
            </div>
